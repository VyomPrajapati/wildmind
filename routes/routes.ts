...
export const IMAGEGENERATION   = {
  ...
  INPAINTFLUXAPI:"/view/inpaint-fluxapi"
} as const;

export const VIDEOGENERATION   = {
  VIDEO_GENERATION: '/view/VIDEOGENERATION/texttovideo',
  IMAGE2V_GENERATION: '/view/VIDEOGENERATION/imagetovideo',
  // STICKER_GENERATION: '/view/IMAGEGENERATIONNEW/AI_Sticker_generation',
  // IMAGE2IMAGEGENERATION:'/view/IMAGEGENERATIONNEW/IMAGETOIMAGE',
  // LIVEPORTRAIT:"/view/IMAGEGENERATIONNEW/LIVEPORTRAIT"
} as const;
...
export const BRANDINGKIT   = {
  ...
  MOCKUPEGNERATION:'/view/BRANDINGKIT/Mockupgeneration',
