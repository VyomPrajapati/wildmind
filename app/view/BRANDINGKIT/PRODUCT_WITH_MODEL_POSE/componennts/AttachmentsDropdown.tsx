  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`p-1 md:p-3 rounded-full md:rounded-xl transition-all duration-300 ease-in-out hover:bg-transparent transition-colors ease-in-out border border-[#8E8E8E] ${
          isOpen
