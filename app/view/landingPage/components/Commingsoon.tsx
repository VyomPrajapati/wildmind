...
const HoverEffectText = ({
  ...
  return (
    <div
      className="flex items-center cursor-pointer mb:-mt-20 relative space-x-[10px] mb:space-x-[6px] mb:justify-center mb:items-center mb:scale-[0.9] mb:origin-center"
