...
import Squares from '../dummylanding/components/Squares'
  ...
  return (
    <footer className="relative z-[10] bg-[#0a1116] w-full">
      <div className="max-w-8xl mx-auto px-6 sm:px-10">
        <div className="relative z-0 pb-2 max-w-7xl mx-auto text-white p-6 sm:p-10 rounded-t-3xl border border-b-0 border-white/20 overflow-hidden ">
